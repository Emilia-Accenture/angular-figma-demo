...
In questo branch c'è l'esempio "who-to-follow" con le specifiche già definite. Basta inserire nel terminale il seguente comando con l'immagine denominata "X.png":

```
/figma-pipeline nome="who-to-follow" 
```
